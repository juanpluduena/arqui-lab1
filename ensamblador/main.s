    ...
    ADD X3, X4, X5
    ADD XZR, XZR, XZR       // NOP para evitar hazard
    ...
    LDUR X12, [X0, #0]
    ADD XZR, XZR, XZR       // NOP para evitar hazard
    ADD XZR, XZR, XZR       // Segundo NOP necesario por LDUR
    ADD X7, X12, XZR
    ...
    CBZ X0, L1
    ADD XZR, XZR, XZR       // NOP por CBZ
    STUR X21, [X0, #128]    // MEM 16:0x0 (si CBZ falla)
L1: 
